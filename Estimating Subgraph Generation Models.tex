...
\hline
\textbf{}&\multicolumn{4}{|c|}{\textbf{Subgraphs of the Triad Census}} \\
\cline{2-5}
\textbf{Model}&\includegraphics[scale=.2]{Figure03_1.pdf}&\includegraphics[scale=.2]{Figure03_2.pdf}&\includegraphics[scale=.2]{Figure03_3.pdf}&\includegraphics[scale=.2]{Figure03_4.pdf}\\
\hline
